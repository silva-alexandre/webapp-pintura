...
class __TwigTemplate_de4abb79b448dae056d96154c510de43 extends Template
{
    ...
    <div class=\"container px-6 py-8 content-above-opacity\">
        <header class=\"row py-5\">
            <div class=\"col-lg-4 d-flex flex-column align-items-center gap-2\">
                <img src=\"https://gr-pintura.com.br/gr-pinturas-logo.png\" alt=\"Logo GR Pinturas\" class=\"mb-4\" style=\"max-width: 200px;\">
            ...
            <div class=\"col-lg-4 mt-2 d-flex flex-column align-items-center gap-2\">
                ...
                <p class=\"arsenal-bold text-center text-black\">Confie na nossa experiência e compromisso com a pontualidade e qualidade para realizar o projeto dos seus sonhos.</p>
...
";
    ...
    {
        return array (  274 => 143,  261 => 133,  248 => 123,  235 => 113,  222 => 103,  209 => 93,  128 => 14,  107 => 10,  90 => 9,  85 => 6,  75 => 5,  58 => 3,  41 => 1,);
    }
...
<section class=\"hero-section position-relative\">
    <div id=\"heroCarousel\" class=\"carousel slide carousel-fade\" data-bs-ride=\"carousel\">
        <div class=\"carousel-inner\">
            {% for i in 1..3 %}
            <div class=\"carousel-item {{ loop.first ? 'active' : '' }}\" style=\"background-image: url('{{ i }}.png');\">
                <!-- O estilo de fundo será aplicado aqui -->
            </div>
            {% endfor %}
        </div>
            ...
            <div class=\"col-6 col-md-4 mb-4\">
                <div class=\"card\">
                    ...
                    <div class=\"card-body text-center\">
                        <h5 class=\"card-title\">Textura Projetada</h5>
                        <p class=\"card-text\">Aplicação para áreas externas</p>
                        <a href=\"{{ path('app_servicos_opcoes') }}\" class=\"stretched-link text-decoration-none text-primary fw-bold\">Saiba mais</a>
                    </div>
                </div>
            </div>
            <div class=\"col-6 col-md-4 mb-4\">
...
{% endblock %}
", "home/index.html.twig", "/var/www/html/gr-pintura/prod-gr/templates/home/index.html.twig");
    }
}
